...
from hybridrecommenderlightfm.utils import read_data, merge_dataset,interactions
from hybridrecommenderlightfm.preprocessing import unique_users,unique_items,features_to_add,mapping
from hybridrecommenderlightfm.model import hybrid_model, evaluate_model
from hybridrecommenderlightfm.train_test_merge import train_test_merge
from hybridrecommenderlightfm.recommendations import get_recommendations
import configparser
import os
...
config_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data', 'config.ini')
...
print(f'{order.shape=}, {customer.shape=}, {product.shape=}')
